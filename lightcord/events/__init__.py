...
events_list = [
   ...
   "ALL_MESSAGE_UPDATE",
   "ALL_MESSAGE_DELETE",
   "ALL_CHANNEL_PINS_UPDATE",
   "ALL_MESSAGE_REACTION_ADD",
   "ALL_MESSAGE_REACTION_REMOVE",
   "ALL_MESSAGE_REACTION_REMOVE_ALL",
   "ALL_MESSAGE_REACTION_REMOVE_EMOJI",
   "ALL_MESSAGE_POLL_VOTE_ADD",
   "ALL_MESSAGE_POLL_VOTE_REMOVE",
   "ALL_TYPING_START"
]
...
events_alias = {
   ...
   "ON_ALL_MESSAGE": "ALL_MESSAGE_CREATE",
   "ON_ALL_MESSAGE_CREATE": "ALL_MESSAGE_CREATE",
   "ON_ALL_MESSAGE_UPDATE": "ALL_MESSAGE_UPDATE",
   "ON_ALL_MESSAGE_EDIT": "ALL_MESSAGE_UPDATE",
   "ON_ALL_MESSAGE_DELETE": "ALL_MESSAGE_DELETE",
}
